...
# Generated by qmake (2.01a) (Qt 4.8.4) on: Wed May 21 16:37:51 2014
...
$(TARGET): ui_commentswindow.h ui_favoriteswindow.h ui_mainwindow.h ui_postwindow.h $(OBJECTS)  
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/instagholam1.0.0/ && $(COPY_FILE) --parents api.h cli.h clickableimage.h comment.h commentswindow.h db.h exception.h favoriteswindow.h friend_request.h hashtag.h mainwindow.h photo.h post.h postwindow.h requestbutton.h user.h user_report.h parser/node.h parser/parser.h parser/XML.h .tmp/instagholam1.0.0/ && $(COPY_FILE) --parents api.cpp cli.cpp clickableimage.cpp comment.cpp commentswindow.cpp db.cpp favoriteswindow.cpp friend_request.cpp hashtag.cpp main.cpp mainwindow.cpp post.cpp postwindow.cpp requestbutton.cpp user.cpp user_report.cpp parser/node.cpp parser/parser.cpp parser/XML.cpp .tmp/instagholam1.0.0/ && $(COPY_FILE) --parents commentswindow.ui favoriteswindow.ui mainwindow.ui postwindow.ui .tmp/instagholam1.0.0/ && (cd `dirname .tmp/instagholam1.0.0` && $(TAR) instagholam1.0.0.tar instagholam1.0.0 && $(COMPRESS) instagholam1.0.0.tar) && $(MOVE) `dirname .tmp/instagholam1.0.0`/instagholam1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/instagholam1.0.0
...
compiler_moc_header_make_all: moc_clickableimage.cpp moc_commentswindow.cpp moc_favoriteswindow.cpp moc_mainwindow.cpp moc_postwindow.cpp moc_requestbutton.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_clickableimage.cpp moc_commentswindow.cpp moc_favoriteswindow.cpp moc_mainwindow.cpp moc_postwindow.cpp moc_requestbutton.cpp
...
compiler_uic_make_all: ui_commentswindow.h ui_favoriteswindow.h ui_mainwindow.h ui_postwindow.h
compiler_uic_clean:
	-$(DEL_FILE) ui_commentswindow.h ui_favoriteswindow.h ui_mainwindow.h ui_postwindow.h
