...
# Generated by qmake (2.01a) (Qt 4.8.4) on: Thu May 15 22:56:02 2014
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/instagholam1.0.0/ && $(COPY_FILE) --parents api.h comment.h db.h exception.h friend_request.h hashtag.h parser.h photo.h post.h user.h user_report.h mainwindow.h .tmp/instagholam1.0.0/ && $(COPY_FILE) --parents api.cpp comment.cpp db.cpp friend_request.cpp hashtag.cpp main.cpp parser.cpp post.cpp user.cpp user_report.cpp mainwindow.cpp .tmp/instagholam1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/instagholam1.0.0/ && (cd `dirname .tmp/instagholam1.0.0` && $(TAR) instagholam1.0.0.tar instagholam1.0.0 && $(COMPRESS) instagholam1.0.0.tar) && $(MOVE) `dirname .tmp/instagholam1.0.0`/instagholam1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/instagholam1.0.0
