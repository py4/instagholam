...
# Generated by qmake (2.01a) (Qt 4.8.4) on: Wed May 21 01:48:31 2014
...
SOURCES       = api.cpp \
		...
		parser/parser.cpp \
		parser/XML.cpp \
		commentswindow.cpp moc_clickableimage.cpp \
		moc_mainwindow.cpp \
		moc_postwindow.cpp \
...
$(TARGET): ui_mainwindow.h ui_postwindow.h ui_commentswindow.h $(OBJECTS)  
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/instagholam1.0.0/ && $(COPY_FILE) --parents api.h cli.h clickableimage.h comment.h db.h exception.h friend_request.h hashtag.h mainwindow.h photo.h post.h postwindow.h user.h user_report.h parser/node.h parser/parser.h parser/XML.h commentswindow.h .tmp/instagholam1.0.0/ && $(COPY_FILE) --parents api.cpp cli.cpp clickableimage.cpp comment.cpp db.cpp friend_request.cpp hashtag.cpp main.cpp mainwindow.cpp post.cpp postwindow.cpp user.cpp user_report.cpp parser/node.cpp parser/parser.cpp parser/XML.cpp commentswindow.cpp .tmp/instagholam1.0.0/ && $(COPY_FILE) --parents mainwindow.ui postwindow.ui commentswindow.ui .tmp/instagholam1.0.0/ && (cd `dirname .tmp/instagholam1.0.0` && $(TAR) instagholam1.0.0.tar instagholam1.0.0 && $(COMPRESS) instagholam1.0.0.tar) && $(MOVE) `dirname .tmp/instagholam1.0.0`/instagholam1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/instagholam1.0.0
...
compiler_moc_header_make_all: moc_clickableimage.cpp moc_mainwindow.cpp moc_postwindow.cpp moc_commentswindow.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_clickableimage.cpp moc_mainwindow.cpp moc_postwindow.cpp moc_commentswindow.cpp
...
compiler_uic_make_all: ui_mainwindow.h ui_postwindow.h ui_commentswindow.h
compiler_uic_clean:
	-$(DEL_FILE) ui_mainwindow.h ui_postwindow.h ui_commentswindow.h
